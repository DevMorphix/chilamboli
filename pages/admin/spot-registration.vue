  ...
  <div class="min-h-screen bg-gray-50 grid grid-rows-[auto_1fr_auto]">
    ...
    <header class="bg-white shadow-sm border-b">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <NuxtLink to="/admin/dashboard/control-center" class="text-blue-600 hover:text-blue-700 text-sm mb-2 inline-block">
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
      <div class="bg-white rounded-lg shadow p-8">
        ...
        <div v-if="!isRegistrationOpen" class="text-center py-12">
          ...
          <p class="text-gray-600 mb-6">New registrations cannot be created at this time.</p>
          <NuxtLink
...
const handleSubmit = async () => {
  ...
  try {
    ...
    setTimeout(() => {
      router.push('/admin/dashboard/control-center')
    }, 2000)
  } catch (err: any) {
