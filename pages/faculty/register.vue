    ...
    <div class="w-full max-w-md">
      ...
      <div class="bg-white rounded-lg shadow-lg p-8">
        ...
        <div class="text-center py-12">
          ...
          <p class="text-gray-600 mb-6">Faculty registration is currently closed. Please contact your administrator for assistance.</p>
          <NuxtLink
            to="/faculty/login"
        ...
        <form v-if="false" @submit.prevent="handleRegister" class="space-y-4">
          <div>
